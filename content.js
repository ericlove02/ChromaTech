...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if (request.message === 'TAB_ACTIVATED_D') {
        ...
        document.querySelectorAll("em").forEach(item => { item.classList.add("duet-secondary") });
        ...
        document.querySelectorAll("em").forEach(item => { item.classList.add("pro-secondary") });
        ...
        document.querySelectorAll("em").forEach(item => { item.classList.add("tri-secondary") });
        ...
        document.querySelectorAll("em").forEach(item => { item.classList.remove("duet-secondary", "pro-secondary", "tri-secondary") });
